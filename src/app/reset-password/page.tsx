...
export const metadata: Metadata = {
  ...
  description: "Choose a new password for your Kirosim account.",
  ...
  if (!token) {
    return (
      <AuthShell title="Reset password" subtitle="This reset link is missing its token.">
        <Link href="/forgot-password" className="text-sm font-medium text-signal underline">Request a new link</Link>
      </AuthShell>
    );
  }
